...
import com.example.modul8_retrofitgetapi.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun Insert(view: View) {
        val intent = Intent(this, com.example.modul8_retrofitgetapi.Fitur.Insert::class.java)
